...
HD_PWD='C:/Users/Alunos/Documents/HGM/PCR/projeto-circuitos-reconfiguraveis/Exercicios/Combinacional/project_1_voto_ABC/project_1_voto_ABC.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log project_1_voto_ABC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_1_voto_ABC.tcl
